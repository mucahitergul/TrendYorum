  ...
  function attachEventListeners() {
    ...
    document.querySelectorAll('.sort-option').forEach(btn => {
      btn.addEventListener('click', () => {
        state.sortOption = btn.dataset.value;
    ...
    // Photo clicks
    document.querySelectorAll('.gallery-photo, .comment-photo').forEach(photo => {
      photo.addEventListener('click', () => {
        openModal(photo.dataset.photo);
      });
    });
    ...
    document.querySelectorAll('.modal-nav-btn').forEach(btn => {
      btn.addEventListener('click', () => {
        navigatePhoto(btn.dataset.direction);
      });
    });
